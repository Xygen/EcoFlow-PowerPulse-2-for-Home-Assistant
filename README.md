...
2. dynamic charging-current/power control during an active session, including
...
readback as a bounded fallback after idle periods; that fallback still needs a
genuine multi-hour idle test.
